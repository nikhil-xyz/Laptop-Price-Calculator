...
from laptop_project.constants import TARGET_COLUMN, SCHEMA_FILE_PATH, CURRENT_YEAR
from laptop_project.entity.config_entity import DataTransformationConfig
from laptop_project.entity.artifact_entity import DataTransformationArtifact, DataIngestionArtifact, DataValidationArtifact
from laptop_project.exception import LaptopException
from laptop_project.logger import logging
from laptop_project.utils.main_utils import save_object, save_numpy_array_data, read_yaml_file, drop_columns
...
class DataTransformation:
    def __init__(self, data_ingestion_artifact: DataIngestionArtifact,
        ...
        data_validation_artifact    : Output reference of data validation artifact stage
        """
        try:
    ...
    def read_data(file_path) -> pd.DataFrame:
        ...
        Output      :   data is returned as pandas DataFrame
        """
        try:
    ...
    def get_data_transformer_object(self) -> Pipeline:
        ...
        try:
            ...
            num_features = self._schema_config['transform_columns'] # transformation is being applied on all numeric features
