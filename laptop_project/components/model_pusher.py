...
from laptop_project.entity.artifact_entity import ModelPusherArtifact, ModelEvaluationArtifact
from laptop_project.entity.config_entity import ModelPusherConfig
...
class ModelPusher:
    def __init__(self, model_evaluation_artifact: ModelEvaluationArtifact,
        ...
        self.laptop_estimator = LaptopEstimator(bucket_name=model_pusher_config.bucket_name,
    ...
    def initiate_model_pusher(self) -> ModelPusherArtifact:
        ...
        try:
            ...
            self.laptop_estimator.save_model(from_file=self.model_evaluation_artifact.trained_model_path)
